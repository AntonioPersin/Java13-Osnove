...
//	private TextField snagaTextField;
	...
	public void unesi() {
		...
		if (naslovTextField.getText().isEmpty()) {
			stofali+="Naslov usluge je obavezan!\n";
		}
		if (opisTextField.getText().isEmpty()) {
			stofali+="Opis usluge je obavezan!\n";
		}
		if(cijenaTextField.getText().isEmpty()) {
			stofali+="Cijena usluge je obavezana!\n";
		}
		if(!stofali.isEmpty()) {
		...
		Usluga uslugica = new Usluga(null,naslovTextField.getText(),opisTextField.getText(), new BigDecimal(cijenaTextField.getText()), stanje);
		
		try {
			BazaPodataka.pohraniNovuUslugu(uslugica);
