...
public class StanoviUnosController {
	...
	public void unesi() {
		...
		if (naslovTextField.getText().isEmpty()) {
			stofali+="Naslov stana je obavezan!\n";
		}
		if (opisTextField.getText().isEmpty()) {
			stofali+="Opis stana je obavezan!\n";
		}
		if(kvadraturaTextField.getText().isEmpty()) {
			stofali+="Kvadratura stana je obavezana!\n";
		}
		if(cijenaTextField.getText().isEmpty()) {
			stofali+="Cijena stana je obavezana!\n";
		}
		if(!stofali.isEmpty()) {
		...
		Stan stancic = new Stan(null,naslovTextField.getText(),opisTextField.getText(), new BigDecimal(cijenaTextField.getText()),new BigDecimal(kvadraturaTextField.getText()), stanje);
		
		try {
			BazaPodataka.pohraniNoviStan(stancic);
