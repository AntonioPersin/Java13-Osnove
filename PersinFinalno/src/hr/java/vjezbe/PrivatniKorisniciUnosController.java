...
public class PrivatniKorisniciUnosController {
	...
	public void unesi() {
		...
		if (imeTextField.getText().isEmpty()) {
			stofali+="Ime korisnika je obavezan!\n";
		}
		if (prezimeTextField.getText().isEmpty()) {
			stofali+="Prezime korisnika je obavezan!\n";
		}
		...
		PrivatniKorisnik user = new PrivatniKorisnik(null,imeTextField.getText(),prezimeTextField.getText(),emailTextField.getText(),telefonTextField.getText());

		try {
			BazaPodataka.pohraniNovogPrivatnogKorisnika(user);
